...
$heading = "REX_VALUE[2]";
$box_per_line = intval("REX_VALUE[3]"); /** @phpstan-ignore-line */
...
?>
	...
	Gewählte Kategorie: <?php print ($category instanceof D2U_Linkbox\Category ? $category->name : 'keine'); /** @phpstan-ignore-line */ ?> 
