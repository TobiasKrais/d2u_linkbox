...
<div class="row">
	<div class="col-xs-4">
		<input type="checkbox" name="REX_INPUT_VALUE[6]" value="true" <?php echo 'REX_VALUE[6]' === 'true' ? ' checked="checked"' : '';  /** @phpstan-ignore-line */ ?> class="form-control d2u_helper_toggle" data-d2u-linkbox-picture-only-source />
	</div>
	<div class="col-xs-8">
...
<div class="row" data-d2u-linkbox-picture-only-target>
	<div class="col-xs-4">
